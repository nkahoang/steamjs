...
***REMOVED***;
  ...
  ***REMOVED******REMOVED***(***REMOVED***;
    ...
    server = http.createServer(function(req, res***REMOVED*** {
      ...
      console.log("Preferred: " + (negotiator.preferredEncodings(***REMOVED******REMOVED******REMOVED***;
      console.log("Possible: " + (negotiator.preferredEncodings(availableEncodings***REMOVED******REMOVED******REMOVED***;
      encoding = negotiator.preferredEncoding(availableEncodings***REMOVED***;
