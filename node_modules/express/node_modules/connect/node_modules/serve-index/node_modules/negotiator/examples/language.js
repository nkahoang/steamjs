...
***REMOVED******REMOVED***(***REMOVED***;
  ...
  server = http.createServer(function(req, res***REMOVED*** {
    ...
    console.log("Preferred: " + (negotiator.languages(***REMOVED******REMOVED******REMOVED***;
    console.log("Possible: " + (negotiator.languages(availableLanguages***REMOVED******REMOVED******REMOVED***;
