...
***REMOVED******REMOVED***(***REMOVED***;
  ...
  server = http.createServer(function(req, res***REMOVED*** {
    ...
    console.log("Preferred: " + (negotiator.charsets(***REMOVED******REMOVED******REMOVED***;
    console.log("Possible: " + (negotiator.charsets(availableCharsets***REMOVED******REMOVED******REMOVED***;
    charset = negotiator.charset(availableCharsets***REMOVED***;
