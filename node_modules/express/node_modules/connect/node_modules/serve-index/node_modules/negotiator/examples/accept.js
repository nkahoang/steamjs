...
***REMOVED******REMOVED***(***REMOVED***;
  ...
  server = http.createServer(function(req, res***REMOVED*** {
    ...
    console.log("Preferred: " + (negotiator.mediaTypes(***REMOVED******REMOVED******REMOVED***;
    console.log("Possible: " + (negotiator.mediaTypes(availableMediaTypes***REMOVED******REMOVED******REMOVED***;
    mediaType = negotiator.mediaType(availableMediaTypes***REMOVED***;
