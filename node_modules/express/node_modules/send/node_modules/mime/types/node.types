...
# Why: To allow apps to (work***REMOVED*** be served with the right content type header.
...
# What: HTML5 application cache manifes ('.manifest' extension***REMOVED***
...
# Why: Required for streaming music to browsers (?***REMOVED***
# Added by: broofa
application/mp4  m4p
audio/mp4  m4a
...
# Added by: creationix (Issue #45***REMOVED***
text/x-lua  lua
