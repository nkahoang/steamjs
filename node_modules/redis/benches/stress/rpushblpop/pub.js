...
function exec(***REMOVED*** {
	pub.rpush('timeline', codec.encode({ foo: payload }***REMOVED******REMOVED***;
	++sent;
...
setInterval(function(***REMOVED*** {
	//var ss = profiler.takeSnapshot('s_' + sent***REMOVED***;
	//console.error(ss.stringify(***REMOVED******REMOVED***;
	pub.llen('timeline', function(err, result***REMOVED*** {
		console.error('sent', sent, 'free', freemem(***REMOVED***,
