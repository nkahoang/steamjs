...
## Attributes
  ...
  some examples:
    ...
    a(href='google.com'***REMOVED*** Google
    a(class='button', href='google.com'***REMOVED*** Google

  As mentioned the attribute values are just JavaScript,
  this means ternary operations and other JavaScript expressions
  work just fine:
  
    body(class=user.authenticated ? 'authenticated' : 'anonymous'***REMOVED***
    a(href=user.website || 'http://google.com'***REMOVED***
...
## Boolean attributes
  ...
  was _true_ the following would also output 'checked="checked"':
     ...
     input(type="checkbox", checked=user.agreed***REMOVED***
...
## Id literal
  ...
  Again we may specify the tag as well:
    ...
    ul#menu
      li: a(href='/home'***REMOVED*** Home
      li: a(href='/store'***REMOVED*** Store
      li: a(href='/contact'***REMOVED*** Contact

  Finally all of these may be used in any combination,
  the following are all valid tags:
  
    a.button#contact(style: 'color: red'***REMOVED*** Contact
    a.button(style: 'color: red'***REMOVED***#contact Contact
    a(style: 'color: red'***REMOVED***.button#contact Contact
...
## Pipe text
  ...
  within the text:
    ...
    p
      | Click to visit
      a(href='http://google.com'***REMOVED*** Google
      | if you want.
...
## Template script tags
  ...
  _type_ attribute such as _text/x-template_:
    ...
    script(type='text/template'***REMOVED***
      h1 Look!
...
## Code
  ...
  _-_, which can be used for conditionals, defining variables etc:
   ...
   If you really want you could even use `.forEach(***REMOVED***` and others:
...
## Conditionals
  ...
  are equivalent:
    ...
    - if (!(user.isAnonymous***REMOVED******REMOVED***
...
## Mixins
  ...
  normal object properties:
      ...
      mixin centered
        .centered(class=attributes.class***REMOVED***
          block
   ...
   get used:
      ...
      mixin link
        a.menu(attributes***REMOVED***
          block
      
      +link.highlight(href='#top'***REMOVED*** Top
      +link#sec1.plain(href='#section1'***REMOVED*** Section 1
      +link#sec2.plain(href='#section2'***REMOVED*** Section 2
   ...
   If you pass arguments, they must directly follow the mixin:
      ...
      mixin list(arr***REMOVED***
        if block
          .title
            block
        ul(attributes***REMOVED***
          each item in arr
            li= item
      
      +list(['foo', 'bar', 'baz']***REMOVED***(id='myList', class='bold'***REMOVED***
