...
exports.minify = function(files, options***REMOVED*** {
  ...
  ***REMOVED******REMOVED***;
    ...
    if (options.spidermonkey***REMOVED*** {
        toplevel = UglifyJS.AST_Node.from_mozilla_ast(files***REMOVED***;
  ***REMOVED*** else {
  ...
  ***REMOVED***
    ...
    var output = {};
    if (typeof options.inSourceMap == "string"***REMOVED*** {
        inMap = fs.readFileSync(options.inSourceMap, "utf8"***REMOVED***;
  ***REMOVED***
    if (options.outSourceMap***REMOVED*** {
      ...
      ***REMOVED******REMOVED***;
        if (options.sourceMapIncludeSources***REMOVED*** {
            for (var file in sourcesContent***REMOVED*** {
                if (sourcesContent.hasOwnProperty(file***REMOVED******REMOVED*** {
                    options.source_map.get(***REMOVED***.setSourceContent(file, sourcesContent[file]***REMOVED***;
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
