...
lift_sequences_2: {
    ...
    input: {
        q = 1 + (foo(***REMOVED***, bar(***REMOVED***, 5***REMOVED*** + 7 * (5 / (3 - (a(***REMOVED***, (QW=ER***REMOVED***, c(***REMOVED***, 2***REMOVED******REMOVED******REMOVED*** - (x(***REMOVED***, y(***REMOVED***, 5***REMOVED***;
  ***REMOVED***
    expect: {
        foo(***REMOVED***, bar(***REMOVED***, a(***REMOVED***, QW = ER, c(***REMOVED***, x(***REMOVED***, y(***REMOVED***, q = 36
  ***REMOVED***
}
