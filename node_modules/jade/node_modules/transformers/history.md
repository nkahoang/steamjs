...
## 2.0.1 - 2013-04-22
 ...
 - Fix global leak of `exportscoffeeScript` (test still fails because `jade` requires an out of date version of `transformers`***REMOVED***
...
## 1.4.0 - 2013-01-25
 ...
 - Report real errors from **less** (rather than objects***REMOVED***
...
## 1.2.1 - 2013-01-09
 ...
 - make **markdown** work when using **markdown** as the engine (**marked** is the recommended engine***REMOVED***.

## 1.2.0 - 2013-01-09

 - **js** (pass through***REMOVED***
 - **css** (pass through***REMOVED***
