...
function testfloat(***REMOVED***
{
	...
	ASSERT.equal(0, mod_ctype.rfloat(buffer, 'big', 0***REMOVED******REMOVED***;
	ASSERT.equal(0, mod_ctype.rfloat(buffer, 'little', 0***REMOVED******REMOVED***;
	...
	ASSERT.equal(Number.POSITIVE_INFINITY,
	    mod_ctype.rfloat(buffer, 'big', 0***REMOVED******REMOVED***;
	buffer[3] = 0x7f;
	buffer[2] = 0x80;
	buffer[1] = 0x00;
	buffer[0] = 0x00;
	ASSERT.equal(Number.POSITIVE_INFINITY,
	    mod_ctype.rfloat(buffer, 'litle', 0***REMOVED******REMOVED***;
	...
	buffer[2] = 0x00;
	buffer[3] = 0x23;
	ASSERT.ok(isNaN(mod_ctype.rfloat(buffer, 'big', 0***REMOVED******REMOVED******REMOVED***;
	buffer[3] = 0x7f;
	buffer[2] = 0x80;
	buffer[1] = 0x00;
	buffer[0] = 0x23;
	ASSERT.ok(isNaN(mod_ctype.rfloat(buffer, 'little', 0***REMOVED******REMOVED******REMOVED***;
	...
	buffer[2] = 0x00;
	buffer[3] = 0x00;
	ASSERT.equal(1.125, mod_ctype.rfloat(buffer, 'big', 0***REMOVED******REMOVED***;

	buffer[3] = 0x3f;
	buffer[2] = 0x90;
	buffer[1] = 0x00;
	buffer[0] = 0x00;
	ASSERT.equal(1.125, mod_ctype.rfloat(buffer, 'little', 0***REMOVED******REMOVED***;
	...
	buffer[0] = 0xb0;
	ASSERT.equal(-2.4010576103645774e+38,
	    mod_ctype.rfloat(buffer, 'little', 0***REMOVED******REMOVED***;
	...
	ASSERT.equal(1161619072,
	    mod_ctype.rfloat(buffer, 'big', 1***REMOVED******REMOVED***;
	ASSERT.equal(-1.2027516403607578e-32,
	    mod_ctype.rfloat(buffer, 'big', 2***REMOVED******REMOVED***;

	ASSERT.equal(8.97661320504413e+34,
	    mod_ctype.rfloat(buffer, 'little', 0***REMOVED******REMOVED***;
	ASSERT.equal(-261661920,
	    mod_ctype.rfloat(buffer, 'little', 1***REMOVED******REMOVED***;
	ASSERT.equal(1.605271577835083,
	    mod_ctype.rfloat(buffer, 'little', 2***REMOVED******REMOVED***;
...
function testdouble(***REMOVED***
{
	...
	buffer[7] = 0;
	ASSERT.equal(0,
	    mod_ctype.rdouble(buffer, 'big', 0***REMOVED******REMOVED***;
	ASSERT.equal(0,
	    mod_ctype.rdouble(buffer, 'little', 0***REMOVED******REMOVED***;
	...
	buffer[6] = 0;
	buffer[7] = 23;
	ASSERT.ok(isNaN(mod_ctype.rdouble(buffer, 'big', 0***REMOVED******REMOVED******REMOVED***;
	...
	buffer[1] = 0;
	buffer[0] = 23;
	ASSERT.ok(isNaN(mod_ctype.rdouble(buffer, 'little', 0***REMOVED******REMOVED******REMOVED***;
	...
	ASSERT.equal(-2.4299184080448593e-88,
	    mod_ctype.rdouble(buffer, 'big', 1***REMOVED******REMOVED***;
	ASSERT.equal(-0.000015130017658081283,
	    mod_ctype.rdouble(buffer, 'big', 2***REMOVED******REMOVED***;

	ASSERT.equal(-5.757458694845505e+302,
	    mod_ctype.rdouble(buffer, 'little', 0***REMOVED******REMOVED***;
	ASSERT.equal(6.436459604192476e-198,
	    mod_ctype.rdouble(buffer, 'little', 1***REMOVED******REMOVED***;
	ASSERT.equal(1.9903745632417286e+275,
	    mod_ctype.rdouble(buffer, 'little', 2***REMOVED******REMOVED***;
}
