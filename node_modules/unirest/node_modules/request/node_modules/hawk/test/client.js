        ...
        describe('#header', function (***REMOVED*** {
            ...
            it('should return a valid authorization header (sha1***REMOVED***', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                var header = Hawk.client.header('http://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about' }***REMOVED***.field;
          ...
          ***REMOVED******REMOVED***;
            ...
            it('should return a valid authorization header (sha256***REMOVED***', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                var header = Hawk.client.header('https://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' }***REMOVED***.field;
          ...
          ***REMOVED******REMOVED***;
            ...
            it('should return a valid authorization header (no ext***REMOVED***', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                var header = Hawk.client.header('https://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' }***REMOVED***.field;
          ...
          ***REMOVED******REMOVED***;
            ...
            it('should return an empty authorization header on missing options', function (done***REMOVED*** {
                ...
                var header = Hawk.client.header('https://example.net/somewhere/over/the/rainbow', 'POST'***REMOVED***.field;
          ...
          ***REMOVED******REMOVED***;
            ...
            it('should return an empty authorization header on invalid credentials', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                var header = Hawk.client.header('https://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207 }***REMOVED***.field;
                expect(header***REMOVED***.to.equal(''***REMOVED***;
                done(***REMOVED***;
          ***REMOVED******REMOVED***;
            ...
            it('should return an empty authorization header on invalid algorithm', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                var header = Hawk.client.header('https://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, payload: 'something, anything!', ext: 'Bazinga!', timestamp: 1353809207 }***REMOVED***.field;
                expect(header***REMOVED***.to.equal(''***REMOVED***;
                done(***REMOVED***;
          ***REMOVED******REMOVED***;
      ***REMOVED******REMOVED***;
        ...
        describe('#authenticate', function (***REMOVED*** {
            ...
            it('should return false on invalid header', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                expect(Hawk.client.authenticate(res, {}***REMOVED******REMOVED***.to.equal(false***REMOVED***;
                done(***REMOVED***;
          ***REMOVED******REMOVED***;
            ...
            it('should return false on invalid mac', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                expect(Hawk.client.authenticate(res, credentials, artifacts***REMOVED******REMOVED***.to.equal(false***REMOVED***;
                done(***REMOVED***;
          ***REMOVED******REMOVED***;
          ...
          ***REMOVED******REMOVED***;
            ...
            it('should fail on invalid WWW-Authenticate header format', function (done***REMOVED*** {
                ...
                expect(Hawk.client.authenticate({ headers: { 'www-authenticate': header } }, {}***REMOVED******REMOVED***.to.equal(false***REMOVED***;
                done(***REMOVED***;
          ***REMOVED******REMOVED***;
            ...
            it('should fail on invalid WWW-Authenticate header format', function (done***REMOVED*** {
              ...
              ***REMOVED***;
                ...
                expect(Hawk.client.authenticate({ headers: { 'www-authenticate': header } }, credentials***REMOVED******REMOVED***.to.equal(false***REMOVED***;
                done(***REMOVED***;
          ***REMOVED******REMOVED***;
      ***REMOVED******REMOVED***;
  ***REMOVED******REMOVED***;
