...
**/
var DeleteCommand = exports.DeleteCommand = function(db, collectionName, selector, flags***REMOVED*** {
  ...
  if(Buffer.isBuffer(object***REMOVED******REMOVED*** {
    ...
    if(object_size != object.length***REMOVED***  {
      var error = new Error("delete raw message size does not match message header size [" + object.length + "] != [" + object_size + "]"***REMOVED***;
...
inherits(DeleteCommand, BaseCommand***REMOVED***;
...
*/
DeleteCommand.prototype.toBinary = function(bsonSettings***REMOVED*** {
...
***REMOVED***
  ...
  var totalLengthOfCommand = 4 + Buffer.byteLength(this.collectionName***REMOVED*** + 1 + 4 + this.db.bson.calculateObjectSize(this.selector, false, true***REMOVED*** + (4 * 4***REMOVED***;
  ...
  _command[_index + 3] = (DeleteCommand.OP_DELETE >> 24***REMOVED*** & 0xff;     
  _command[_index + 2] = (DeleteCommand.OP_DELETE >> 16***REMOVED*** & 0xff;
  _command[_index + 1] = (DeleteCommand.OP_DELETE >> 8***REMOVED*** & 0xff;
  ...
  if(Buffer.isBuffer(this.selector***REMOVED******REMOVED*** {
    documentLength = this.selector.length;
    // Copy the data into the current buffer
    this.selector.copy(_command, _index***REMOVED***;
***REMOVED*** else {
    documentLength = this.db.bson.serializeWithBufferAndIndex(this.selector, false, _command, _index***REMOVED*** - _index + 1;
***REMOVED***
