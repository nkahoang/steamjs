...
**/
var QueryCommand = exports.QueryCommand = function(db, collectionName, queryOptions, numberToSkip, numberToReturn, query, returnFieldSelector, options***REMOVED*** {
...
inherits(QueryCommand, BaseCommand***REMOVED***;
 ...
 */
QueryCommand.prototype.setMongosReadPreference = function(readPreference, tags***REMOVED*** {
  // No read preference specified
  if(readPreference == false***REMOVED*** return;
  // If we have readPreference set to true set to secondary prefered
  if(readPreference == true***REMOVED*** {
    readPreference = 'secondaryPreferred';
***REMOVED*** else if(readPreference == 'false'***REMOVED*** {
...
***REMOVED***
  ...
  if((readPreference != null || tags != null***REMOVED*** && this.query['$query'] == null***REMOVED*** {
    this.query = {'$query': this.query};
***REMOVED***

  // If we have no readPreference set and no tags, check if the slaveOk bit is set
  if(readPreference == null && tags == null***REMOVED*** {
    // If we have a slaveOk bit set the read preference for MongoS
    if(this.queryOptions & QueryCommand.OPTS_SLAVE***REMOVED*** {
...
***REMOVED***
  ...
  if(typeof readPreference == 'object' && readPreference['_type'] == 'ReadPreference'***REMOVED*** {
    this.query['$readPreference'] = readPreference.toObject(***REMOVED***;
***REMOVED*** else if(readPreference != null***REMOVED*** {
    // Add the read preference
    this.query['$readPreference'] = {mode: readPreference};

    // If we have tags let's add them
    if(tags != null***REMOVED*** {
...
*/
QueryCommand.prototype.toBinary = function(bsonSettings***REMOVED*** {
...
***REMOVED***
  ...
  if(Buffer.isBuffer(this.query***REMOVED******REMOVED*** {
    totalLengthOfCommand = 4 + Buffer.byteLength(this.collectionName***REMOVED*** + 1 + 4 + 4 + this.query.length + (4 * 4***REMOVED***;
***REMOVED*** else {
    totalLengthOfCommand = 4 + Buffer.byteLength(this.collectionName***REMOVED*** + 1 + 4 + 4 + this.db.bson.calculateObjectSize(this.query, this.serializeFunctions, true***REMOVED*** + (4 * 4***REMOVED***;
***REMOVED***

  // Calculate extra fields size
  if(this.returnFieldSelector != null && !(Buffer.isBuffer(this.returnFieldSelector***REMOVED******REMOVED******REMOVED***  {
    if(Object.keys(this.returnFieldSelector***REMOVED***.length > 0***REMOVED*** {
      totalLengthOfCommand += this.db.bson.calculateObjectSize(this.returnFieldSelector, this.serializeFunctions, true***REMOVED***;
  ***REMOVED***
***REMOVED*** else if(Buffer.isBuffer(this.returnFieldSelector***REMOVED******REMOVED*** {
...
***REMOVED***
  ...
  _command[_index + 3] = (QueryCommand.OP_QUERY >> 24***REMOVED*** & 0xff;
  _command[_index + 2] = (QueryCommand.OP_QUERY >> 16***REMOVED*** & 0xff;
  _command[_index + 1] = (QueryCommand.OP_QUERY >> 8***REMOVED*** & 0xff;
  _command[_index] = QueryCommand.OP_QUERY & 0xff;
  // Adjust index
  _index = _index + 4;

  // Write the query options
  _command[_index + 3] = (this.queryOptions >> 24***REMOVED*** & 0xff;
  _command[_index + 2] = (this.queryOptions >> 16***REMOVED*** & 0xff;
  _command[_index + 1] = (this.queryOptions >> 8***REMOVED*** & 0xff;
  ...
  _command[_index + 3] = (this.numberToSkip >> 24***REMOVED*** & 0xff;
  _command[_index + 2] = (this.numberToSkip >> 16***REMOVED*** & 0xff;
  _command[_index + 1] = (this.numberToSkip >> 8***REMOVED*** & 0xff;
  _command[_index] = this.numberToSkip & 0xff;
  // Adjust index
  _index = _index + 4;

  // Write the number of documents to return
  _command[_index + 3] = (this.numberToReturn >> 24***REMOVED*** & 0xff;
  _command[_index + 2] = (this.numberToReturn >> 16***REMOVED*** & 0xff;
  _command[_index + 1] = (this.numberToReturn >> 8***REMOVED*** & 0xff;
...
***REMOVED*** else {
    ...
    documentLength = this.db.bson.serializeWithBufferAndIndex(object, this.checkKeys, _command, _index, this.serializeFunctions***REMOVED*** - _index + 1;
***REMOVED***
  ...
  if(this.returnFieldSelector != null && !(Buffer.isBuffer(this.returnFieldSelector***REMOVED******REMOVED******REMOVED***  {
    if(Object.keys(this.returnFieldSelector***REMOVED***.length > 0***REMOVED*** {
      var documentLength = this.db.bson.serializeWithBufferAndIndex(this.returnFieldSelector, this.checkKeys, _command, _index, this.serializeFunctions***REMOVED*** - _index + 1;
      // Write the length to the document
      _command[_index + 3] = (documentLength >> 24***REMOVED*** & 0xff;
      _command[_index + 2] = (documentLength >> 16***REMOVED*** & 0xff;
      _command[_index + 1] = (documentLength >> 8***REMOVED*** & 0xff;
      ...
      _command[_index - 1] = 0;
  ***REMOVED***
***REMOVED*** if(this.returnFieldSelector != null && Buffer.isBuffer(this.returnFieldSelector***REMOVED******REMOVED***  {
    // Document binary length
    var documentLength = 0
