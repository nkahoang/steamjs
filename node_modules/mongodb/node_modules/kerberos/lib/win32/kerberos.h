...
public:
  ...
  // Method available
  static Handle<Value> AcquireAlternateCredentials(const Arguments &args***REMOVED***;
  static Handle<Value> PrepareOutboundPackage(const Arguments &args***REMOVED***;
  static Handle<Value> DecryptMessage(const Arguments &args***REMOVED***;
  static Handle<Value> EncryptMessage(const Arguments &args***REMOVED***;
  static Handle<Value> QueryContextAttributes(const Arguments &args***REMOVED***;
