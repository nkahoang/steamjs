...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="generator" content="HTML Tidy for Mac OS X (vers 31 October 2006 - Apple Inc. build 13***REMOVED***, see www.w3.org" /><title>W3C Software Notice and License</title><link rel="stylesheet" href="/2008/site/css/minimum" type="text/css" media="handheld, all" /><style type="text/css" media="print, screen and (min-width: 481px***REMOVED***" xml:space="preserve">
     @import url("/2008/site/css/advanced"***REMOVED***;
</style><link href="/2008/site/css/minimum" rel="stylesheet" type="text/css" media="handheld, only screen and (max-device-width: 480px***REMOVED***" /><meta name="viewport" content="width=device-width" /><link rel="stylesheet" href="/2008/site/css/print" type="text/css" media="print" /><link rel="shortcut icon" href="/2008/site/images/favicon.ico" type="image/x-icon" /></head><body id="www-w3-org" class="w3c_public"><div id="w3c_container">
    ...
    <h3 class="category"><span class="ribbon"><a href="/Consortium/Legal/ipr-notice.html" title="Up to Policies and Legal Information">Policies and Legal Information <img src="/2008/site/images/header-link" alt="Header link" width="13" height="13" class="header-link" /></a></span></h3>
       ...
       <div id="w3c_crumbs_frame">
        <ul class="bct"> <!-- .bct / Breadcrumbs -->
          <li class="skip"><a tabindex="1" accesskey="2" title="Skip to content (e.g., when browsing via audio***REMOVED***" href="#w3c_content_body">Skip</a></li>
...
related items***REMOVED*** is being provided by the copyright holders under the following
license.</p>
<h2>License</h2>
                     
                     <p class="tPadding">
By obtaining, using and/or copying this work, you (the licensee***REMOVED***
...
modifications:</p>
    ...
    Notice</a> should be included (hypertext is preferred, text is permitted***REMOVED***
    ...
    which the code is derived.***REMOVED***</li></ul>
...
Definition</a>.</p>
         ...
         <div id="w3c_footer-inner">
            ...
            <p class="copyright">Copyright &#xA9; 2012 W3C <sup>&#xAE;</sup> (<a href="http://www.csail.mit.edu/">
               ...
               </a>, <a href="http://www.keio.ac.jp/">Keio</a>***REMOVED*** <a href="/Consortium/Legal/ipr-notice">Usage policies apply</a>.</p>
         </div>
