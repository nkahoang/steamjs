 ...
 */
var arrays = require('./arrays'***REMOVED***,
    chaining = require('./chaining'***REMOVED***,
    collections = require('./collections'***REMOVED***,
    functions = require('./functions'***REMOVED***,
    objects = require('./objects'***REMOVED***,
    utilities = require('./utilities'***REMOVED***,
    baseEach = require('./internals/baseEach'***REMOVED***,
    forOwn = require('./objects/forOwn'***REMOVED***,
    isArray = require('./objects/isArray'***REMOVED***,
    lodashWrapper = require('./internals/lodashWrapper'***REMOVED***,
    mixin = require('./utilities/mixin'***REMOVED***,
    support = require('./support'***REMOVED***,
    templateSettings = require('./utilities/templateSettings'***REMOVED***;
 ...
 * @example
 *
 * var wrapped = _([1, 2, 3]***REMOVED***;
 *
 * // returns an unwrapped value
 * wrapped.reduce(function(sum, num***REMOVED*** {
 *   return sum + num;
 * }***REMOVED***;
 * // => 6
 *
 * // returns a wrapped value
 * var squares = wrapped.map(function(num***REMOVED*** {
 *   return num * num;
 * }***REMOVED***;
 *
 * _.isArray(squares***REMOVED***;
 * // => false
 *
 * _.isArray(squares.value(***REMOVED******REMOVED***;
 * // => true
 */
function lodash(value***REMOVED*** {
  // don't wrap if already wrapped, even if wrapped by a different `lodash` constructor
  return (value && typeof value == 'object' && !isArray(value***REMOVED*** && hasOwnProperty.call(value, '__wrapped__'***REMOVED******REMOVED***
   ? value
   : new lodashWrapper(value***REMOVED***;
}
// ensure `new lodashWrapper` is an instance of `lodash`
lodashWrapper.prototype = lodash.prototype;

// wrap `_.mixin` so it works when provided only one argument
mixin = (function(fn***REMOVED*** {
  var functions = objects.functions;
  return function(object, source, options***REMOVED*** {
    if (!source || (!options && !functions(source***REMOVED***.length***REMOVED******REMOVED*** {
    ...
    ***REMOVED***
      ...
      object = lodash;
  ***REMOVED***
    return fn(object, source, options***REMOVED***;
***REMOVED***;
}(mixin***REMOVED******REMOVED***;
...
mixin(function(***REMOVED*** {
  var source = {}
  forOwn(lodash, function(func, methodName***REMOVED*** {
    if (!lodash.prototype[methodName]***REMOVED*** {
...
forOwn(lodash, function(func, methodName***REMOVED*** {
  ...
  if (!lodash.prototype[methodName]***REMOVED*** {
    lodash.prototype[methodName]= function(n, guard***REMOVED*** {
      var chainAll = this.__chain__,
          result = func(this.__wrapped__, n, guard***REMOVED***;

      return !chainAll && (n == null || (guard && !(callbackable && typeof n == 'function'***REMOVED******REMOVED******REMOVED***
        ? result
        : new lodashWrapper(result, chainAll***REMOVED***;
  ***REMOVED***;
***REMOVED***
}***REMOVED***;
...
baseEach(['join', 'pop', 'shift'], function(methodName***REMOVED*** {
  var func = arrayRef[methodName];
  lodash.prototype[methodName] = function(***REMOVED*** {
    var chainAll = this.__chain__,
        result = func.apply(this.__wrapped__, arguments***REMOVED***;
...
baseEach(['push', 'reverse', 'sort', 'unshift'], function(methodName***REMOVED*** {
  var func = arrayRef[methodName];
  lodash.prototype[methodName] = function(***REMOVED*** {
    func.apply(this.__wrapped__, arguments***REMOVED***;
    return this;
***REMOVED***;
}***REMOVED***;

// add `Array` functions that return new wrapped values
baseEach(['concat', 'slice', 'splice'], function(methodName***REMOVED*** {
  var func = arrayRef[methodName];
  lodash.prototype[methodName] = function(***REMOVED*** {
    return new lodashWrapper(func.apply(this.__wrapped__, arguments***REMOVED***, this.__chain__***REMOVED***;
***REMOVED***;
}***REMOVED***;

// avoid array-like object bugs with `Array#shift` and `Array#splice`
// in IE < 9, Firefox < 10, Narwhal, and RingoJS
if (!support.spliceObjects***REMOVED*** {
  baseEach(['pop', 'shift', 'splice'], function(methodName***REMOVED*** {
    var func = arrayRef[methodName],
    ...
    lodash.prototype[methodName] = function(***REMOVED*** {
      var chainAll = this.__chain__,
          ...
          result = func.apply(value, arguments***REMOVED***;

      if (value.length === 0***REMOVED*** {
        delete value[0];
    ***REMOVED***
      return (chainAll || isSplice***REMOVED***
        ? new lodashWrapper(result, chainAll***REMOVED***
        : result;
  ***REMOVED***;
***REMOVED******REMOVED***;
...
(lodash.templateSettings = utilities.templateSettings***REMOVED***.imports._ = lodash;
