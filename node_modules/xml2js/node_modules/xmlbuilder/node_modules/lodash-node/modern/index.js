...
var arrays = require('./arrays'***REMOVED***,
    ...
    forEach = require('./collections/forEach'***REMOVED***,
...
forEach(['join', 'pop', 'shift'], function(methodName***REMOVED*** {
...
forEach(['push', 'reverse', 'sort', 'unshift'], function(methodName***REMOVED*** {
  var func = arrayRef[methodName];
  lodash.prototype[methodName] = function(***REMOVED*** {
...
forEach(['concat', 'slice', 'splice'], function(methodName***REMOVED*** {
  var func = arrayRef[methodName];
  lodash.prototype[methodName] = function(***REMOVED*** {
