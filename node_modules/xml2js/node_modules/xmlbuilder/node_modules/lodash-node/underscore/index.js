...
function lodash(value***REMOVED*** {
  return (value instanceof lodash***REMOVED***
    ? value
...
mixin = (function(fn***REMOVED*** {
  return function(object, source***REMOVED*** {
    if (!source***REMOVED*** {
      source = object;
      object = lodash;
  ***REMOVED***
    return fn(object, source***REMOVED***;
***REMOVED***;
...
lodash.prototype.value = chaining.wrapperValueOf;
  ...
  forEach(['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift'], function(methodName***REMOVED*** {
    var func = arrayRef[methodName];
    lodash.prototype[methodName] = function(***REMOVED*** {
      var value = this.__wrapped__;
      func.apply(value, arguments***REMOVED***;

      // avoid array-like object bugs with `Array#shift` and `Array#splice`
      // in Firefox < 10 and IE < 9
      if (!support.spliceObjects && value.length === 0***REMOVED*** {
        delete value[0];
    ***REMOVED***
      return this;
  ***REMOVED***;
***REMOVED******REMOVED***;
  ...
  forEach(['concat', 'join', 'slice'], function(methodName***REMOVED*** {
    var func = arrayRef[methodName];
    lodash.prototype[methodName] = function(***REMOVED*** {
      var value = this.__wrapped__,
          result = func.apply(value, arguments***REMOVED***;

      if (this.__chain__***REMOVED*** {
        result = new lodashWrapper(result***REMOVED***;
